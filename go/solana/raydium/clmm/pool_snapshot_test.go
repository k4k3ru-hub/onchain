...
func TestPoolSnapshotUsesFrozenPriceInputs(t *testing.T) {
	...
	if got.Protocol != "clmm" || len(got.PriceInputs) == 0 || got.PriceInputs[0].ReceivedAt.IsZero() {
	...
	putUint128LE(snap.accounts.Accounts[snap.pool].Account.Data[253:269], new(big.Int).Lsh(big.NewInt(2), 64))
	binary.LittleEndian.PutUint32(snap.accounts.Accounts[snap.pool].Account.Data[269:273], 0)
	...
	if value.FloatString(18) != "4.000000000000000000" {
